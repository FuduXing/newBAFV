...
def data_set(data_name):
    if not data_name in ['mnist', 'fashion-mnist', 'purchase', 'adult', 'cifar10', 'cifar100']:
        raise TypeError('data_name should be a string, including mnist,fashion-mnist,purchase,adult,cifar10,cifar100. ')
